                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            @endif
                            <form class="form-valide" action="{{route('sisterconcurnslider.update',$slider->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="name" class="form-control" id="">
                                            ...
                                            <option value="{{ $name->id??''}}" {{ @$name->id == $slider->name ?  'selected':'' }}>{{$name->name??''}}</option>
                                            @endforeach
